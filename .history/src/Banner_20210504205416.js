        ...
        >
            <div className="banner_contents ml-8 pt-36 h-48">
                ...
                <div className="banner_buttons">
                    <button className="cursor-pointer text-white bg-gray-700 outline-none border-none font-bold rounded-sm px-8 mr-4 pb-1">Play</button>
                    <button className="cursor-pointer text-white bg-white outline-none border-none font-bold rounded-sm px-8 mr-4">My List</button>
                </div>
