    ...
    >
      ...
      <div className="loginScreen_body absolute top-1/3 z-10 text-white px-10 text-center mr-auto ml-auto">
          <>
            ...
            <h3 className="text-sm font-thin text-center">Ready to start? Enter your email to create or restart your membership.</h3>
            <div className="loginScreen_input p-3 ">
                <form className="">
                    ...
                    <button className="loginScreen_getStarted text-base text-white bg-orange-netflix border-none font-semibold cursor-pointer px-2 py-4">GET STARTED</button>
                </form>
            </div>
          </>
      </div>
