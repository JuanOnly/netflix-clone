  ...
  return (
    <div className="profileScreen h-screen text-white">
      ...
      <div className="profileScreen_body flex flex-col w-2/4 ml-auto mr-auto pt-20 max-w-3xl">
        <h1 className="text-6xl font-normal border-b border-gray-light mb-5">
          Edit Profile
        </h1>
        <div className="profileScreen_ info flex">
          ...
          <div className="profileScreen_details text-white ml-6 flex-1">
            ...
            <div className="profileScreen_plans mt-5">
              <h3 className="border-b border-gray-light pb-2">Plans</h3>
              <button
                onClick={() => auth.signOut()}
                className="profileName_signOut border-none py-2 px-5 mt-2 w-full text-white bg-orange-netflix"
              >
                Sign Out
              </button>
            </div>
