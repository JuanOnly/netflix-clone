    ...
    >
      ...
      <div className="loginScreen_body absolute top-1/3 z-10 text-white px-10 text-center mr-auto ml-auto">
          <>
            ...
            <h2 className="text-2xl font-normal mb-7 text-center">Watch anywhere. Cancel any time.</h2>
            <h3 className="text-sm font-extralight text-center">Ready to start? Enter your email to create or restart your membership.</h3>
            <div className="loginScreen_input p-3 ">
                <form className="">
                    <input className=" p-2 h-10 w-1/3 border-none max-w-screen-sm outline-none" type="email" placeholder="Email Adress" />
                    <button className="loginScreen_getStarted text-base text-white bg-orange-netflix border-none font-semibold cursor-pointer px-3 py-2">GET STARTED</button>
                </form>
            </div>
          </>
      </div>
