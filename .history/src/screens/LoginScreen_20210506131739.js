...
const LoginScreen = () => {
  return (
    <div
      className="loginScreen relative h-full bg-center bg-no-repeat bg-cover bg-gradient-to-t from-gray-black opacity-80 via-transparent to-gray-black opacity-80"
      style={{
        backgroundImage:
    ...
    >
      <div className="loginScreen_background ">
        ...
        <div className="loginScreen_gradient w-full h-screen z-10"></div>
      </div>
    </div>
  );
};
