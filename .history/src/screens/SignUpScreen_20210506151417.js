    ...
    return (
        <div className="signupScreen max-w-xs p-16 mr-auto ml-auto bg-black opacity-80">
            <form >
                ...
                <button className="rounded-md cursor-pointer mt-2 font-medium m-1 p-16 py-2 text-sm text-white outline-none bg-orange-netflix" type="submit">Sign In</button>
