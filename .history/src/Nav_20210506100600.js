...
function Nav() {
  ...
  return (
    <div className={`nav_black ${show && "bg-gradient-to-b from-black to-gray-sdark via-gray-sdark"} fixed top-0 p-5 w-full h-16 z-10 transition ease-in duration-500`}>
