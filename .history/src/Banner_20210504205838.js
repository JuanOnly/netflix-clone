        ...
        >
            <div className="banner_contents ml-8 pt-36 h-48">
                ...
                <div className="banner_buttons">
                    <button className="cursor-pointer text-white bg-gray-900 outline-none border-none font-bold rounded-sm px-8 mr-4 pb-1 hover:bg-white hover:text-black transition delay-200">Play</button>
                    <button className="cursor-pointer text-white bg-gray-900 outline-none border-none font-bold rounded-sm px-8 mr-4 pb-1">My List</button>
                </div>
