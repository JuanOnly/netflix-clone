    ...
    return (
        ...
        >
            <div className="banner_contents ml-8 pt-36 h-48">
                ...
                <h1 className="banner_discription w-96 leading-5 pt-4 text-sm max-w-xs h-20 overflow-ellipsis">This is a discriptionThis is a discriptionThis is a discriptionThis is a discription</h1>
            </div>
